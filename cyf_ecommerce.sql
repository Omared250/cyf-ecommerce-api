...
-- Retrieve all the products with their corresponding suppliers. The result should only contain the columns product_name, 
...
-- Retrieve all the products sold by suppliers based in the United Kingdom. The result should only contain the columns 
...
-- Retrieve all the products in the order ORD006. The result should only contain the 
-- columns product_name, unit_price and quantity.
select 
	p.product_name,
	p.unit_price,
	oi.quantity 
